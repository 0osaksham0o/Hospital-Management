...
class PrescriptionControllerTest {
    ...
    private PrescriptionProjection projection(int phId, int ptSsn, int medCode,
                                              LocalDate date, String dose) {
        return new PrescriptionProjection() {
            public Integer   getPhysicianId()    { return phId;    }
            public Integer   getPatientSsn()     { return ptSsn;   }
            public Integer   getMedicationCode() { return medCode; }
            public LocalDate getDate()           { return date;    }
            public String    getDose()           { return dose;    }
            public Integer   getAppointmentId()  { return null;    }
        };
    }
    ...
    void testGetAll() throws Exception {
        ...
        PrescriptionProjection p = projection(1, 101, 1001, null, "2x daily");
        Page<PrescriptionProjection> page = new PageImpl<>(List.of(p), PageRequest.of(0, 5), 1);

        when(prescriptionRepository.findAllProjectedBy(any(Pageable.class))).thenReturn(page);
    ...
    void testGetById() throws Exception {
        ...
        when(prescriptionRepository.findProjectedById(id)).thenReturn(Optional.of(p));

        mockMvc.perform(get("/api/prescriptions/1/101/1001"))
                .andExpect(status().isOk());
    }
    ...
    void testGetByIdNotFound() throws Exception {
        ...
        PrescriptionId id = new PrescriptionId(1, 101, 1001);
        when(prescriptionRepository.findProjectedById(id)).thenReturn(Optional.empty());
    ...
    void testCreatePrescription() throws Exception {
        ...
        PrescriptionId id = new PrescriptionId(1, 101, 1001);
        Prescription prescription = new Prescription(); prescription.setId(id);
        PrescriptionProjection p = projection(1, 101, 1001, LocalDate.of(2026, 5, 16), "2 times daily");
    ...
    void testUpdatePrescription() throws Exception {
        ...
        PrescriptionId id = new PrescriptionId(1, 101, 1001);
        PrescriptionProjection p = projection(1, 101, 1001, LocalDate.of(2026, 5, 16), "Updated dose");
        ...
        mockMvc.perform(put("/api/prescriptions/1/101/1001")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk());
    }
    ...
    void testDeletePrescription() throws Exception {
        ...
        mockMvc.perform(delete("/api/prescriptions/1/101/1001"))
                .andExpect(status().isOk())
